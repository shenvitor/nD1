...
//
//
/// \file nD1RunAction.hh
/// \brief Definition of the nD1RunAction class

#ifndef nD1RunAction_h
#define nD1RunAction_h 1
...
class nD1RunAction : public G4UserRunAction
{
  public:
    nD1RunAction();
    virtual ~nD1RunAction();
